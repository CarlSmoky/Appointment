...
const AddAppointments = ({ onSendAppointment, lastId }) => {
  ...
  const formDataPublish = () => {
    const appointmentInfo = {
      ...
      aptData: formData.aptData + " " + formData.aptTime,
  ...
  return (
    <div>
      <button
        ...
        className={`bg-teal-800/60 text-white px-2 py-3 w-full text-left hover:bg-teal-800/70 rounded-t-md ${toggleForm ? 'rounded-t-md' : 'rounded-md'}`}>
        <div><BiCalendarPlus className="inline-block align-text-top" />  Add Appointment</div>
      </button>
      {toggleForm && <div className="border-r-2 border-b-2 border-l-2 border-stone-500 rounded-b-md pl-4 pr-4 pb-4">
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input
              ...
              className="max-w-lg block w-full shadow-sm focus:ring-stone-500 focus:border-yellow
              -500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input
              ...
              className="max-w-lg block w-full shadow-sm focus:ring-stone-500 focus:border-stone-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input
              ...
              className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-yellow-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
          </div>
        </div>
        ...
        <div className="pt-5">
          <div className="flex justify-end">
            <button
              ...
              className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-teal-800/60 hover:bg-teal-800/70 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-400"
            >
              Submit
            </button>
          </div>
